	...
	if (typeof map !== "undefined") {
		...
		$("#map-layers").append(
			'<li data-layer-id="' +
				map.id +
				'">\
                <input type="hidden" name="interactive-map-layers[' +
				map.id +
				'][id]" value="' +
				map.id +
				'">\
                <input type="text" name="interactive-map-layers[' +
				map.id +
				'][name]" value="' +
				map.title +
				'">\
				...
				'\
                <div class="actions">\
                    <button type="button" class="button button-link" data-action="interactive-map-toggle-layer" data-layer-id="' +
				map.id +
				'"><span class="dashicons dashicons-hidden"></span></button>\
                    <button type="button" class="button button-link" data-action="interactive-map-remove-layer" data-layer-id="' +
				map.id +
